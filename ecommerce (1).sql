...
modify column cliente_id int auto_increment unique;

alter table enderecos
modify column cliente_id int auto_increment;
...
values
('Colônia Rodrigo Mendes','6774','Embaúbas','ferreira','SC','18944-467'),
('Rua das Flores', '123', 'Centro', 'São Paulo', 'SP', '01001-000'),
('Avenida Brasil', '456', 'Jardim América', 'Rio de Janeiro', 'RJ', '22000-000'),
('Travessa da Paz', '789', 'Vila Nova', 'Belo Horizonte', 'MG', '30000-000'),
('Alameda Santos', '101', 'Paraíso', 'São Paulo', 'SP', '01418-000'),
('Rua Augusta', '202', 'Consolação', 'São Paulo', 'SP', '01305-000'),
('Avenida Paulista', '303', 'Bela Vista', 'São Paulo', 'SP', '01311-000'),
('Rua Oscar Freire', '404', 'Jardins', 'São Paulo', 'SP', '01426-000'),
('Rua 25 de Março', '505', 'Centro', 'São Paulo', 'SP', '01021-000'),
('Avenida Atlântica', '606', 'Copacabana', 'Rio de Janeiro', 'RJ', '22021-000'),
('Rua Visconde de Pirajá', '707', 'Ipanema', 'Rio de Janeiro', 'RJ', '22410-000'),
('Rua do Ouvidor', '808', 'Centro', 'Rio de Janeiro', 'RJ', '20040-000'),
('Avenida Afonso Pena', '909', 'Centro', 'Belo Horizonte', 'MG', '30130-000'),
('Rua da Bahia', '111', 'Centro', 'Belo Horizonte', 'MG', '30160-000'),
('Avenida Contorno', '222', 'Funcionários', 'Belo Horizonte', 'MG', '30110-000'),
('Rua Sete de Setembro', '333', 'Centro', 'Curitiba', 'PR', '80020-000'),
('Avenida República Argentina', '444', 'Água Verde', 'Curitiba', 'PR', '80620-000'),
('Rua XV de Novembro', '555', 'Centro', 'Curitiba', 'PR', '80010-000'),
('Avenida Beira Mar', '666', 'Meireles', 'Fortaleza', 'CE', '60165-000'),
('Rua Iracema', '777', 'Praia de Iracema', 'Fortaleza', 'CE', '60060-000'),
('Avenida Dom Manuel', '888', 'Centro', 'Fortaleza', 'CE', '60060-000'),
('Rua da Concórdia', '999', 'Centro', 'Recife', 'PE', '50020-000'),
('Avenida Boa Viagem', '121', 'Boa Viagem', 'Recife', 'PE', '51020-000'),
('Rua do Imperador', '232', 'Santo Antônio', 'Recife', 'PE', '50010-000'),
('Avenida Tocantins', '343', 'Setor Oeste', 'Goiânia', 'GO', '74110-000'),
('Rua 7', '454', 'Setor Oeste', 'Goiânia', 'GO', '74115-000'),
('Avenida Goiás', '565', 'Centro', 'Goiânia', 'GO', '74030-000'),
('Rua João Pessoa', '676', 'Centro', 'Porto Alegre', 'RS', '90010-000'),
('Avenida Farrapos', '787', 'São João', 'Porto Alegre', 'RS', '90200-000'),
('Rua dos Andradas', '898', 'Centro', 'Porto Alegre', 'RS', '90020-000');
...
alter table produtos
modify column estoque int not null;
...
insert into pedidos
(data_pedido,status,total)
values
(NOW(),'Cancelado','905.56'),
(NOW(),'Cancelado','598.73'),
(NOW(),'pago','886.63'),
(NOW(),'Enviado','1035.27'),
(NOW(),'Pendente','277.5'),
(NOW(), 'Pago', 450.75),
...
(NOW(), 'Entregue', 325.50),
(NOW(), 'Pendente', 178.30),
(NOW(), 'Cancelado', 620.45),
(NOW(), 'Pago', 1125.80),
(NOW(), 'Enviado', 755.25),
(NOW(), 'Entregue', 289.90),
(NOW(), 'Pendente', 425.60),
(NOW(), 'Cancelado', 950.15),
(NOW(), 'Pago', 678.40),
(NOW(), 'Enviado', 1342.75),
(NOW(), 'Entregue', 523.10),
(NOW(), 'Pendente', 198.85),
(NOW(), 'Cancelado', 785.20),
(NOW(), 'Pago', 2345.90),
(NOW(), 'Enviado', 876.35),
(NOW(), 'Entregue', 412.65),
(NOW(), 'Pendente', 567.80),
(NOW(), 'Cancelado', 1234.50),
(NOW(), 'Pago', 987.25),
(NOW(), 'Enviado', 654.70),
(NOW(), 'Entregue', 321.95),
(NOW(), 'Pendente', 876.40),
(NOW(), 'Cancelado', 543.20);
