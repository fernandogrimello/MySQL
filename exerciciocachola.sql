...
ALTER TABLE comvenda CHANGE n_numeclienint n_numeclien int not null;
...
ALTER TABLE comclien ADD COLUMN c_estaclen varchar(50);
ALTER TABLE comclien DROP COLUMN c_estaclen;
